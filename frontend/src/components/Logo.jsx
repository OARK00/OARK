export default function Logo({ size = 32, wordmark = false }) {
  const mark = (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      {/* chip body */}
      <rect x="7" y="7" width="18" height="18" rx="3" fill="#00e5ff" fillOpacity="0.12" stroke="#00e5ff" strokeWidth="1.6" />
      {/* circuit trace */}
      <path
      ...
      />
      <circle cx="12" cy="16" r="1.4" fill="#00e5ff" />
      <circle cx="20" cy="19" r="1.4" fill="#00e5ff" />
    </svg>
  );
